...
- **Compliance Target:** Which external standard or regulation does this also satisfy

- **Implementation Detail:** What specifically is being done

- **Evidence:** Where the supporting documenta¡¡¡¢tion lives in this vault
...
## Gap Analysis Note
The “Planned” controls show where the policy or procedure is set up, but the technical part hasn’t been put into action yet. In a typical company, you’d find these on a Plan of Action and Milestones (POA&M) document. The gap analysis is in the Findings Summary. 
