...
Design a framework to safeguard organizational data by adhering to industry-standard compliance requirements (NIST-CSF). Develop a searchable, audit-ready documentation package housed within a centralized knowledge base.

## What Is an ISMS?

An **Information Security Management System** (ISMS) is a structured set of policies, processes, and controls that an organization employs to manage information security risks. It is not a standalone piece of software or a single document; rather, it is a comprehensive system of management that integrates various components to ensure effective information security.
...
1. **It is function-oriented.** The six functions (Govern, Identify, Protect, Detect, Respond, Recover) tell a story that spans from establishing leadership accountability to recovering from incidents.
...
*This page drives every policy decision in the document. A healthcare company or a startup would make different choices even using the same NIST CSF framework. The mock org exists to demonstrate that controls must be tailored to context.*
